...
Run: `cargo test kiro::provider::tests::fallback --lib`
...
Run: `cargo test anthropic::tool_schema::tests::repairs_bidirectional_tool_field_aliases --lib`
...
Run: `cargo test anthropic::tool_schema::tests::repairs_json_encoded_required_array --lib`
...
Run: `cargo test kiro::provider::tests --lib && cargo test anthropic::tool_schema::tests --lib`
Expected: PASS，零失败。

- [ ] **Step 2: Run full library tests and build**
